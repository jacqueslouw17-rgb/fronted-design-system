...
export default function EmployeeSettingsDrawer({ 
  open, 
  onOpenChange, 
  employee,
  onSave,
  onBack 
}: EmployeeSettingsDrawerProps) {
  ...
  const [formData, setFormData] = useState<ContractorPayment>({
    id: employee?.id || "",
    name: employee?.name || "",
          ...
          <div className="p-6 space-y-6">
            <SheetHeader>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <SheetTitle className="text-xl">{formData.name} - Settings</SheetTitle>
                  <p className="text-sm text-muted-foreground">
                    Configure employee-specific payroll settings
                  </p>
                </div>
              </div>
            </SheetHeader>
