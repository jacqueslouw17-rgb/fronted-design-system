...
import { ReviewCheck } from "./CA3_ReviewCheckCard";

interface CA3_FixCheckDrawerProps {
  open: boolean;
...
export const CA3_FixCheckDrawer: React.FC<CA3_FixCheckDrawerProps> = ({
  open,
  onOpenChange,
  check,
  onSave,
...
export default CA3_FixCheckDrawer;
