...
const AdjustmentRow = ({ 
  ...
  return (
    <>
      <div 
        className="flex items-center justify-between py-2 cursor-pointer hover:bg-orange-100/70 dark:hover:bg-orange-500/15 -mx-1 px-1 rounded transition-colors"
