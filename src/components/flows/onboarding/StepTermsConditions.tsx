/**
 * Flow 5 — Step 2: Terms & Conditions
 * 
...
const StepTermsConditions: React.FC<StepTermsConditionsProps> = ({ onComplete, isProcessing }) => {
    ...
    >
      <div className="space-y-2">
        ...
        <p className="text-sm text-muted-foreground">
          Review and accept the terms to access your dashboard.
        </p>
      </div>
      ...
      <div className="flex items-center justify-center gap-2 text-xs text-muted-foreground">
        ...
        <span>Secure sign-in. Your credentials are never shared.</span>
      </div>

      <Button
        onClick={handleGoToDashboard}
        disabled={!termsAccepted || isProcessing || isSubmitting}
        className="w-full"
        size="lg"
      >
        {isProcessing || isSubmitting ? "Processing..." : "Go to Dashboard"}
