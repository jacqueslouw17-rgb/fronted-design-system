...
interface F41v8_ConfirmPayDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  periodLabel: string;
}

export const F41v8_ConfirmPayDialog = ({ open, onOpenChange, periodLabel }: F41v8_ConfirmPayDialogProps) => {
  const { submitForReview, payrollStatus } = useF41v8_DashboardStore();
