...
interface F41v8_SubmitNoChangesDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  periodLabel: string;
}

export const F41v8_SubmitNoChangesDialog = ({ 
  open, 
  onOpenChange, 
  periodLabel 
}: F41v8_SubmitNoChangesDialogProps) => {
  const { submitNoChanges } = useF41v8_DashboardStore();
