...
export const CA4_SubmitConfirmationModal: React.FC<CA4_SubmitConfirmationModalProps> = ({
  open,
  onOpenChange,
  onConfirm,
  employeeCount,
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-sm">
        ...
        <div className="space-y-5 py-4">
          ...
          {/* Warnings if any */}
          {warningCount > 0 && (
            <div className="flex items-center justify-center gap-2 py-2 px-3 rounded-lg bg-accent-amber-fill/5 text-xs text-accent-amber-text">
...
export default CA4_SubmitConfirmationModal;
