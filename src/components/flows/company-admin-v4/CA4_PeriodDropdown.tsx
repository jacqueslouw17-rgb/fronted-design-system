/**
 * CA4_PeriodDropdown — Premium period selector
 * Grouped sections, animated status dots, accent bars, glassmorphism
 * Simplified interface (no frequency/payDate)
 */
  ...
  return (
    <Popover open={isOpen} onOpenChange={setIsOpen}>
      ...
      <PopoverContent
        align="center"
        sideOffset={10}
        className="w-[300px] p-0 bg-popover/95 backdrop-blur-xl border border-border/60 rounded-xl shadow-2xl shadow-black/10 overflow-hidden"
      >
        {/* Active */}
        {active.length > 0 && (
          <div>
