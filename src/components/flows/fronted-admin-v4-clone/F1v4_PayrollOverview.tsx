...
export const F1v4_PayrollOverview: React.FC<F1v4_PayrollOverviewProps> = ({
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-8 pb-16 sm:pb-32 space-y-8">
      ...
      <div className="overflow-x-auto scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0 sm:overflow-visible pb-1">
        <div className="flex sm:grid sm:grid-cols-4 gap-2 sm:gap-4 w-max sm:w-auto">
          <div className="w-32 sm:w-auto p-2.5 sm:p-4 rounded-xl border border-border/40 bg-card/50 backdrop-blur-sm">
          ...
          <div className="w-32 sm:w-auto p-2.5 sm:p-4 rounded-xl border border-destructive/20 bg-destructive/5">
          ...
          <div className="w-32 sm:w-auto p-2.5 sm:p-4 rounded-xl border border-amber-500/20 bg-amber-500/5">
          ...
          <div className="w-32 sm:w-auto p-2.5 sm:p-4 rounded-xl border border-accent-green-outline/20 bg-accent-green-fill/5">
