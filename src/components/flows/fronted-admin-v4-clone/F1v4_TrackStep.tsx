...
const MOCK_TRACKED_WORKERS: WorkerData[] = [
  { id: "1", name: "Marcus Chen", type: "contractor", country: "Singapore", currency: "EUR", status: "ready", netPay: 8200, issues: 0, paymentStatus: "in-progress" },
  ...
  { id: "6", name: "Emma Wilson", type: "contractor", country: "Norway", currency: "EUR", status: "ready", netPay: 6770, issues: 0, paymentStatus: "in-progress" },
