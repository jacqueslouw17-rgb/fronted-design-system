...
interface F41v3_PayslipHistoryDrawerProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

// Mock payslips data - can be replaced with real data later
...
export const F41v3_PayslipHistoryDrawer = ({
  open,
  onOpenChange,
}: F41v3_PayslipHistoryDrawerProps) => {
                ...
                >
                  ...
                  <div className="flex items-center gap-3 ml-2">
                    ...
                    <Button
                      ...
                      aria-label={`Download payslip for ${payslip.period}`}
                    >
