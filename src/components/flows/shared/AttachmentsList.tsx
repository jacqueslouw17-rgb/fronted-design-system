      ...
      {attachments.map((att) => {
        ...
        return (
          <div
            key={att.id}
            className={cn(
              "flex items-center gap-2.5 rounded-md border border-border/30 bg-muted/20 group transition-colors cursor-pointer hover:bg-muted/70 hover:border-border/60",
