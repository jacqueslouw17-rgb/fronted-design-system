    ...
    <div className="max-w-6xl mx-auto p-4 sm:p-8 pb-16 sm:pb-32 space-y-8">
      ...
      <div className="overflow-x-auto scrollbar-hide -mx-4 px-4 sm:mx-0 sm:px-0 sm:overflow-visible pb-1">
        <div className="flex sm:grid sm:grid-cols-4 gap-2 sm:gap-4 w-max sm:w-auto">
          <div className="v7-stat-card w-32 sm:w-auto">
          ...
          <div className="v7-stat-card w-32 sm:w-auto border-destructive/20">
          ...
          <div className="v7-stat-card w-32 sm:w-auto border-amber-500/20">
          ...
          <div className="v7-stat-card w-32 sm:w-auto border-accent-green-outline/20">
        ...
        {filteredCompanies.map((company, index) => {
          ...
          return (
            <motion.div
              ...
              className={cn(
                "v7-glass-item group relative cursor-pointer",
