...
import type { CountryTemplate, DocumentTemplate, TemplateAuditEntry } from "./F1v7_CountryTemplatesSection";
  ...
  return (
    <>
      <Sheet open={open} onOpenChange={(v) => {
        ...
        <SheetContent
          side="right"
          className="w-[85%] sm:w-[60vw] sm:max-w-[60vw] p-0 flex flex-col"
          hideClose
        >
          {/* ── Header ── */}
