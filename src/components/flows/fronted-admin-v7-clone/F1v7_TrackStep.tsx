...
import { F1v4_WorkerDetailDrawer, WorkerData } from "./F1v7_WorkerDetailDrawer";
...
const HISTORICAL_PAYROLLS: HistoricalPayroll[] = [
  {
    ...
    currencyCount: 3,
    workers: [
      { id: "1", name: "Marcus Chen", type: "contractor", country: "Singapore", currency: "SGD", status: "ready", netPay: 11500, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-112234", companyName: "Acme Corp" },
      { id: "2", name: "Sofia Rodriguez", type: "contractor", country: "Spain", currency: "EUR", status: "ready", netPay: 6200, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-112235", companyName: "Acme Corp" },
      { id: "3", name: "Maria Santos", type: "employee", country: "Philippines", currency: "PHP", status: "ready", netPay: 275000, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-112236", companyName: "Globex Inc" },
      { id: "4", name: "Alex Hansen", type: "employee", country: "Norway", currency: "NOK", status: "ready", netPay: 64000, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-112237", companyName: "Globex Inc" },
      { id: "5", name: "Emma Wilson", type: "contractor", country: "Norway", currency: "NOK", status: "ready", netPay: 70000, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-112238", companyName: "Waystar Royco" },
      { id: "6", name: "David Martinez", type: "contractor", country: "Portugal", currency: "EUR", status: "ready", netPay: 4100, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-112139", companyName: "Initech Ltd" },
      { id: "7", name: "Jonas Schmidt", type: "employee", country: "Germany", currency: "EUR", status: "ready", netPay: 5700, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-112239", companyName: "Initech Ltd" },
    ],
  },
  {
    id: "nov-2025",
    ...
    currencyCount: 3,
    workers: [
      { id: "1", name: "Marcus Chen", type: "contractor", country: "Singapore", currency: "SGD", status: "ready", netPay: 11000, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-111234", companyName: "Acme Corp" },
      { id: "2", name: "Sofia Rodriguez", type: "contractor", country: "Spain", currency: "EUR", status: "ready", netPay: 6100, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-111235", companyName: "Acme Corp" },
      { id: "3", name: "Maria Santos", type: "employee", country: "Philippines", currency: "PHP", status: "ready", netPay: 270000, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-111236", companyName: "Globex Inc" },
      { id: "4", name: "Alex Hansen", type: "employee", country: "Norway", currency: "NOK", status: "ready", netPay: 63000, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-111237", companyName: "Globex Inc" },
      { id: "5", name: "Emma Wilson", type: "contractor", country: "Norway", currency: "NOK", status: "ready", netPay: 68000, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-111238", companyName: "Waystar Royco" },
      { id: "6", name: "Jonas Schmidt", type: "employee", country: "Germany", currency: "EUR", status: "ready", netPay: 5600, issues: 0, paymentStatus: "paid", providerRef: "PAY-2025-111239", companyName: "Initech Ltd" },
    ],
  },
];
...
const MOCK_TRACKED_WORKERS: WorkerData[] = [
  { id: "1", name: "Marcus Chen", type: "contractor", country: "Singapore", currency: "SGD", status: "ready", netPay: 12000, issues: 0, paymentStatus: "in-progress", companyName: "Acme Corp" },
  { id: "2", name: "Sofia Rodriguez", type: "contractor", country: "Spain", currency: "EUR", status: "ready", netPay: 6500, issues: 0, paymentStatus: "in-progress", companyName: "Acme Corp" },
  { id: "3", name: "Maria Santos", type: "employee", country: "Philippines", currency: "PHP", status: "ready", netPay: 280000, issues: 0, paymentStatus: "in-progress", companyName: "Globex Inc" },
  { id: "4", name: "Alex Hansen", type: "employee", country: "Norway", currency: "NOK", status: "ready", netPay: 65000, issues: 0, paymentStatus: "in-progress", companyName: "Globex Inc" },
  { id: "5", name: "David Martinez", type: "contractor", country: "Portugal", currency: "EUR", status: "ready", netPay: 4200, issues: 0, paymentStatus: "in-progress", companyName: "Initech Ltd" },
  { id: "6", name: "Emma Wilson", type: "contractor", country: "Norway", currency: "NOK", status: "ready", netPay: 72000, issues: 0, paymentStatus: "in-progress", companyName: "Waystar Royco" },
  { id: "7", name: "Jonas Schmidt", type: "employee", country: "Germany", currency: "EUR", status: "ready", netPay: 5800, issues: 0, paymentStatus: "in-progress", companyName: "Waystar Royco" },
];
