              ...
              {payrollOptIn && (
                <div className="px-4 pb-4 space-y-3 border-t border-border/30 pt-3">
                  ...
                  <div className="space-y-3">
                    ...
                    {/* Generic fallback */}
                    {formData.country !== "India" && formData.country !== "Philippines" && (
                  ...
                  <div className="space-y-3 border-t border-border/30 pt-3">
                    ...
                    <Field label="Account Holder Name">
                      <Input value={accountHolder || formData.name} onChange={e => setAccountHolder(e.target.value)} placeholder="As per bank records" className="h-10" />
                    </Field>
