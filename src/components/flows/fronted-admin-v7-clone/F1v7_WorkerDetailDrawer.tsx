...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  expired: { label: "Expired", className: "bg-muted/50 text-muted-foreground border-border/40" },
};
...
export const F1v4_WorkerDetailDrawer: React.FC<F1v4_WorkerDetailDrawerProps> = ({
    ...
    return (
      <>
        <Sheet open={open} onOpenChange={onOpenChange}>
          <SheetContent overlayClassName="z-[110]" className="w-[440px] sm:max-w-[440px] p-0 flex flex-col overflow-hidden z-[120]">
            {/* Clean Header */}
  ...
  return (
    <>
      <Sheet open={open} onOpenChange={onOpenChange}>
        <SheetContent overlayClassName="z-[110]" className="w-[480px] sm:max-w-[480px] p-0 flex flex-col overflow-hidden z-[120]">
