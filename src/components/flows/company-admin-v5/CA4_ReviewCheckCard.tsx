...
interface CA4_ReviewCheckCardProps {
  check: ReviewCheck;
...
export const CA4_ReviewCheckCard: React.FC<CA4_ReviewCheckCardProps> = ({
  check,
  onFixNow,
  onAcknowledge,
  onSkip,
    ...
    switch (severity) {
      ...
      case "warning":
        return {
          ...
          bgColor: "bg-accent-amber-fill/10",
          label: "Warning",
        };
      case "info":
        return {
...
export default CA4_ReviewCheckCard;
