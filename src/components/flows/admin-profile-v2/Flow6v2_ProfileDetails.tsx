/**
 * Flow 6 Company Admin Dashboard v2 - Profile Details Editor
...
interface Flow6v2ProfileDetailsProps {
  formData: {
    companyName?: string;
    hqCountry?: string;
    adminName?: string;
...
const Flow6v2ProfileDetails = ({ formData, onSave, onCancel }: Flow6v2ProfileDetailsProps) => {
            ...
            <div className="space-y-2 bg-card/40 border border-border/40 rounded-lg p-4">
              ...
              <div className="flex flex-wrap gap-2">
                {data.selectedCountries.map((code) => {
                  const country = COUNTRIES_V2.find(c => c.code === code);
                  return (
...
export default Flow6v2ProfileDetails;