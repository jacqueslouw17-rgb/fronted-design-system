...
interface FrontedAdminV4UserManagementProps {
  formData: Record<string, any>;
  onComplete: (stepId: string, data?: Record<string, any>) => void;
  isProcessing?: boolean;
}

const FrontedAdminV4UserManagement = ({ 
  formData, 
  onComplete, 
  isProcessing 
}: FrontedAdminV4UserManagementProps) => {
  ...
  const [users, setUsers] = useState<V4AdminUser[]>(initialUsers);
          ...
          >
            ...
            <div className="bg-card/20 border border-border/30 rounded-lg p-5 space-y-4">
              <div className="space-y-2">
                <Label htmlFor="v4userName" className="text-sm">
              ...
              <div className="space-y-2">
                <Label htmlFor="v4userEmail" className="text-sm">
...
export default FrontedAdminV4UserManagement;
