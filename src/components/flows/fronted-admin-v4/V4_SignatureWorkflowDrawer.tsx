...
interface V4_SignatureWorkflowDrawerProps {
  open: boolean;
...
type SigningStatus = "sent_to_candidate" | "candidate_signed" | "certified";
...
export const V4_SignatureWorkflowDrawer: React.FC<V4_SignatureWorkflowDrawerProps> = ({
  open,
  onOpenChange,
  candidate,
  onComplete
  ...
  useEffect(() => {
    if (candidate) {
      ...
      const now = new Date();
      const sentToAdminsTime = new Date(now.getTime() - 5 * 60000); // 5 minutes ago
      const sentToCandidateTime = now;
      ...
      setContractItems([
        {
          ...
          status: "complete",
          timestamp: sentToAdminsTime.toLocaleString()
        },
        {
          ...
          status: "complete",
          timestamp: sentToCandidateTime.toLocaleString()
        },
        {
          id: "candidate_signed",
