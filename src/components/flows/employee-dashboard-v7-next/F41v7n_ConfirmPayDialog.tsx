...
interface F41v7n_ConfirmPayDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  periodLabel: string;
}

export const F41v7n_ConfirmPayDialog = ({ open, onOpenChange, periodLabel }: F41v7n_ConfirmPayDialogProps) => {
  const { submitForReview, payrollStatus } = useF41v7n_DashboardStore();
