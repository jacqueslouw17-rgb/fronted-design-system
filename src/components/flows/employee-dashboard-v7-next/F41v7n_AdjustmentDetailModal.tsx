...
import { type F41v7n_Adjustment } from '@/stores/F41v7n_DashboardStore';
import { FileText, Clock, AlertTriangle } from 'lucide-react';

interface F41v7n_AdjustmentDetailModalProps {
  adjustment: F41v7n_Adjustment | null;
  onClose: () => void;
  currency: string;
}
...
export const F41v7n_AdjustmentDetailModal = ({ adjustment, onClose, currency }: F41v7n_AdjustmentDetailModalProps) => {
