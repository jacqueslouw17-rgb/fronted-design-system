...
interface F41v7n_SubmitNoChangesDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  periodLabel: string;
}

export const F41v7n_SubmitNoChangesDialog = ({ 
  open, 
  onOpenChange, 
  periodLabel 
}: F41v7n_SubmitNoChangesDialogProps) => {
  const { submitNoChanges } = useF41v7n_DashboardStore();
