/**
 * F41v7n_SupportPanel - Support & Feedback Panel for Flow 4.1 v8 Next
 * 
 * Worker-themed categories. Standard (non-glass) styling.
...
interface F41v7n_SupportPanelProps {
  isOpen: boolean;
  onClose: () => void;
}
...
export const F41v7n_SupportPanel: React.FC<F41v7n_SupportPanelProps> = ({
  isOpen,
  onClose,
}) => {
            ...
            >
              ...
              <form onSubmit={handleSupportSubmit} className="p-4 sm:p-5 space-y-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="v7n-supportMessage" className="text-sm font-medium">Message</Label>
                  <Textarea
                    id="v7n-supportMessage"
          ...
          {view === "feedback-form" && (
            ...
            >
              ...
              <form onSubmit={handleFeedbackSubmit} className="p-4 sm:p-5 space-y-5">
                <div className="space-y-2">
                  <Label htmlFor="v7n-feedbackContext" className="text-sm font-medium">Context / Page</Label>
                  <Input
                    id="v7n-feedbackContext"
                ...
                <div className="space-y-2">
                  <Label htmlFor="v7n-feedbackMessage" className="text-sm font-medium">Your Feedback</Label>
                  <Textarea
                    id="v7n-feedbackMessage"
