/**
 * F1v6_KurtVisualizer - Interactive frequency pulsing visualizer for Kurt
 * Matches the v3 AudioWaveVisualizer design - blue gradient waves with hover interaction
 */
import React, { useState, useEffect } from 'react';
import { motion, AnimatePresence } from 'framer-motion';
import { useF1v6Agent } from './F1v6_AgentContext';

export const F1v6_KurtVisualizer: React.FC = () => {
  const { isOpen, toggleOpen } = useF1v6Agent();
