...
import { AgentState, AgentMessage, AgentAction, UIHighlight } from './F1v6_AgentTypes';
...
export const F1v6_AgentProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
...
export const useF1v6Agent = () => {
  const context = useContext(AgentContext);
  if (!context) {
    throw new Error('useF1v6Agent must be used within a F1v6_AgentProvider');
  }
  return context;
};
