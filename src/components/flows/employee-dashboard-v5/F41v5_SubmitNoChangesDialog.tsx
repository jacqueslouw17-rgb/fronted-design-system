...
interface F41v5_SubmitNoChangesDialogProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
  periodLabel: string;
}

export const F41v5_SubmitNoChangesDialog = ({ 
  open, 
  onOpenChange, 
  periodLabel 
}: F41v5_SubmitNoChangesDialogProps) => {
  const { submitNoChanges } = useF41v5_DashboardStore();
