...
export const FlowCard = ({ flowId, onPatternClick }: FlowCardProps) => {
  const flowsData = {
    'flow-1-admin-onboarding': {
      ...
      iconColor: "amber",
      icon: Workflow,
      title: "Flow 1 - Company Admin Onboarding v1",
      locked: true,
      deprecated: true,
    ...
    'flow-6-company-admin-dashboard-v2': {
      ...
      locked: false,
      deprecated: false,
      description: "Editable version of v1: Single-tenant dashboard for company admins to view certified workers and access contracts/certificates. This version is unlocked for development.",
      steps: "1 view",
      patterns: "2 patterns",
      badges: [
        { label: "Data Summary Cards", path: "/data-summary" },
