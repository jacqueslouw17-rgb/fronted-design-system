  ...
  return (
    <div className={`flex gap-3 ${className}`}>
      <Button
        ...
        className="rounded-full h-10 px-5 gap-2 border border-primary/50 text-foreground bg-background/95 backdrop-blur-sm shadow-[0_10px_24px_-12px_hsl(var(--primary)/0.40)] hover:bg-primary/10 hover:border-primary hover:scale-105 transition-all"
