              ...
              <div className={cn(
                ...
                <div className="flex items-center justify-between gap-2">
                  <div className="flex items-center gap-2 flex-1">
                    ...
                    {items.length > 0 && !["data-pending", "awaiting-signature", "onboarding-pending", "payroll-ready", "CERTIFIED", "PAYROLL_PENDING", "IN_BATCH", "EXECUTING", "PAID", "ON_HOLD"].includes(status) && (
                      <Checkbox
                    ...
                    <Card className="hover:shadow-card transition-shadow cursor-pointer border border-border/40 bg-card/50 backdrop-blur-sm">
                      <CardContent className="p-3 space-y-2">
                        ...
                        <div className="flex items-start gap-2">
                          {!["data-pending", "awaiting-signature", "onboarding-pending", "payroll-ready", "CERTIFIED"].includes(status) &&
