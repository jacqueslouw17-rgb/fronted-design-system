...
export const patternLayout = {
  ...
  // Header section
  header: "border-b border-border bg-card px-4 sm:px-6 py-5 rounded-lg shadow-card",
  headerTitle: "text-xl sm:text-2xl font-semibold text-foreground",
  headerDescription: "text-muted-foreground text-sm mt-1.5",
  
  // Content card
  contentCard: "border rounded-lg p-4 sm:p-6 bg-card shadow-card",
  
  // Demo section
  demoSection: "space-y-4",
