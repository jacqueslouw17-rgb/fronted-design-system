/**
 * Flow 2.1 - Company Admin v1
 * 
 * Independent multi-company contracting flow with company switching.
 * Changes to this flow DO NOT affect Flow 2.1 — Fronted Admin v1.
 */
...
const CompanyAdminV1 = () => {
  ...
  useEffect(() => {
    ...
    if (phaseParam === "bundle-creation") {
      ...
      navigate("/flows/contract-flow-company-admin", { replace: true });
    }
              ...
              <AnimatePresence mode="wait">
                    ...
                    <div className="space-y-4">
                      <div className="mt-3">
                          <PipelineView 
                            ...
                            onSignatureComplete={() => {
                              navigate("/flows/contract-flow-company-admin?phase=data-collection&allSigned=true");
                            }}
                          />
                      </div>
                      </div>
                ...
                <motion.div key="bundle-creation" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col min-h-full">
                  <div className="max-w-7xl mx-auto w-full px-6 pt-4 pb-2 flex items-center justify-between">
                    ...
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => { contractFlow.proceedToDataCollection(); navigate("/flows/contract-flow-company-admin?phase=data-collection"); }}
                    ...
                    {contractFlow.selectedCandidates.map((candidate) => (
                      <div key={candidate.id} className="space-y-6">
                        ...
                        <DocumentBundleCarousel
                          ...
                          hideButton={true}
                          onClose={() => navigate("/flows/contract-flow-company-admin")}
                        />
                      </div>
                    ))}
                    <motion.div
                ...
                <motion.div key="drafting" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="flex flex-col min-h-full">
                  <div className="max-w-7xl mx-auto w-full px-6 pt-4 pb-2 flex items-center justify-between">
                    <Button 
                      ...
                      className="gap-2"
                      onClick={() => {
                        navigate("/flows/contract-flow-company-admin?phase=bundle-creation");
                      }}
                    >
                      <ArrowLeft className="h-4 w-4" />
                      Back
                  ...
                  <div className="flex-1 p-8">
                    <ContractReviewBoard 
                      ...
                      onStartSigning={() => { 
                        ...
                        navigate("/flows/contract-flow-company-admin?phase=data-collection&moved=true");
                      }}
                    />
                  </div>
                </motion.div>
                ...
                <motion.div key="document-bundle-signature" initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }}>
                  <DocumentBundleSignature 
                    ...
                    onClose={() => { contractFlow.proceedToDataCollection(); navigate("/flows/contract-flow-company-admin?phase=data-collection"); }}
                  />
                </motion.div>
