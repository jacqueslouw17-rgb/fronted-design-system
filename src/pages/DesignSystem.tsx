        ...
        <Tabs defaultValue={defaultTab} className="w-full">
          ...
          <TabsContent value="flows" className="mt-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Link to="/flows/admin-payroll-dashboard">
                <Card className="hover:shadow-lg transition-all group h-full">
                  <CardHeader>
                    <div className="flex items-center gap-3 mb-3">
                      <div className="p-2 rounded-xl bg-purple-500/10 border border-purple-500/20 transition-all duration-200 group-hover:bg-purple-600 group-hover:border-purple-600">
                        <DollarSign className="h-5 w-5 text-purple-600 dark:text-purple-400 transition-colors duration-200 group-hover:text-white" />
                      </div>
                      <CardTitle className="text-lg">Flow 6 — Payroll Certification Sync</CardTitle>
                    </div>
                    <CardDescription className="line-clamp-3">
                      Real-time synchronized payroll certification between admin and candidate: Kurt monitors compliance, resolves issues, and tracks progress with live checklist updates across both dashboards.
                    </CardDescription>
                    <div className="flex items-center gap-2 text-xs text-muted-foreground pt-2">
                    ...
                    <div className="flex flex-wrap gap-1.5">
                      <Badge 
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          handlePatternClick('/agent-contextual-timeline');
                        }}
                      >
                        Real-time Sync
                      </Badge>
                      ...
                      <Badge 
                        ...
                        onClick={(e) => {
                          e.preventDefault();
                          e.stopPropagation();
                          handlePatternClick('/notification-center');
                        }}
                      >
                        Kurt Alerts
                      </Badge>
                  ...
                  return (
                    ...
                    >
                      ...
                      <CardContent className="pt-0 space-y-2">
                        ...
                        {component.usedInPatterns.length > 0 && (
