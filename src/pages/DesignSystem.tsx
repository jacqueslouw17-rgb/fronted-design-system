  ...
  return <div className="min-h-screen bg-background flex flex-col items-center p-4 sm:p-6 md:p-8">
      <div className="max-w-7xl w-full space-y-6 sm:space-y-8">
        ...
        <Tabs defaultValue={defaultTab} className="w-full">
          ...
          <TabsContent value="flows" className="mt-8 space-y-10">
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      ...
                      <FlowCard key="flow-4.1-employee-dashboard-v7-next" flowId="flow-4.1-employee-dashboard-v7-next" onPatternClick={handlePatternClickWrapper} />
