/**
 * Flow 4.2 — Contractor Dashboard v4 Profile Settings
 * 
 * Isolated profile settings for v4 contractors with Documents section.
...
const F42v4_ProfileSettings = () => {
  ...
  const getReturnUrl = () => {
    ...
    return '/candidate-dashboard-contractor-v4';
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-background via-background/95 to-primary/5">
      ...
      <AgentLayout context="contractor-profile-settings-v4">
...
export default F42v4_ProfileSettings;
