...
import { F1v5_CompanyAdministratorsDetail } from "@/components/flows/entity-v1/F1v7_CompanyAdministratorsDetail";
import { F1v5_TeamMembersSection } from "@/components/flows/entity-v1/F1v7_TeamMembersSection";
import { F1v5_RolesPermissionsSection } from "@/components/flows/entity-v1/F1v7_RolesPermissionsSection";
import { F1v7_ExportSection } from "@/components/flows/entity-v1/F1v7_ExportSection";
...
const F1v7_ProfileSettings = () => {
  ...
  return (
    <div className="v7-glass-bg">
      ...
      <FrostedHeader
        onLogoClick={() => navigate("/flows/entity-v1")}
