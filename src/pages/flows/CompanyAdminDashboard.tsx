...
const CompanyAdminDashboard = () => {
  ...
  const filteredWorkers = useMemo(() => {
    ...
    return mockCertifiedWorkers.filter(worker => worker.name.toLowerCase().includes(query) || worker.role.toLowerCase().includes(query));
  }, [searchQuery]);
  ...
  return <RoleLensProvider initialRole="admin">
      <TooltipProvider>
        <div className="flex flex-col h-screen bg-background text-foreground overflow-hidden">
          ...
          <Topbar userName="Admin User" profileSettingsUrl="/admin/profile-settings" dashboardUrl="/flows/company-admin-dashboard" />
