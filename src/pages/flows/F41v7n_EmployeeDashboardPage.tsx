...
import { 
  F41v7n_PayoutHeroCard, 
  F41v7n_PayslipsSection, 
  F41v7n_PayoutBreakdownDrawer,
  F41v7n_AdjustmentsSection,
  F41v7n_AdjustmentModal
} from "@/components/flows/employee-dashboard-v7-next";
import { F41v7n_SupportBubble } from "@/components/flows/employee-dashboard-v7-next/F41v7n_SupportBubble";
...
const F41v7n_EmployeeDashboardPage = () => {
      ...
      <TooltipProvider>
        <div className="flex flex-col min-h-screen bg-background">
          <Topbar 
            ...
            profileSettingsUrl="/flows/employee-profile-settings-v7-next?returnUrl=/candidate-dashboard-employee-v7-next" 
            dashboardUrl="/candidate-dashboard-employee-v7-next" 
          />
...
export default F41v7n_EmployeeDashboardPage;
