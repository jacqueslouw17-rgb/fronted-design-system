 ...
 * 
 * Duplicate of Flow 5 (Candidate Dashboard) for employee payroll cycle.
 * This flow will later be updated to support the employee payroll cycle 
 * (after payroll posting & payslips).
 * 
 * Currently a clean clone — no modifications yet.
 */
      ...
      <TooltipProvider>
        <div className="flex flex-col min-h-screen bg-background">
          ...
          <div className="flex-1">
            <AgentLayout context="Employee Payroll">
