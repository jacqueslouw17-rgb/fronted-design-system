...
export const FLOW_REGISTRY: Record<string, FlowMetadata> = {
  ...
  'f4.2-contractor-dashboard-v4': {
    ...
    lockedReason: undefined,
    filePaths: [
      'src/pages/flows/F41v5_EmployeeDashboardPage.tsx',
      'src/stores/F41v5_DashboardStore.ts'
    ]
  },
  'f4.2-contractor-dashboard-v5': {
    id: 'f4.2-contractor-dashboard-v5',
    ...
    lockedReason: undefined,
    filePaths: [
      'src/pages/flows/F42v5_ContractorDashboardPage.tsx',
      'src/stores/F42v5_DashboardStore.ts'
    ]
  },
  'f4.1-employee-dashboard-v6': {
    ...
    lockedReason: undefined,
    filePaths: [
      'src/pages/flows/F41v6_EmployeeDashboardPage.tsx',
      'src/stores/F41v6_DashboardStore.ts'
    ]
  },
  'f4.2-contractor-dashboard-v6': {
    ...
    lockedReason: undefined,
    filePaths: [
      'src/pages/flows/F42v6_ContractorDashboardPage.tsx',
